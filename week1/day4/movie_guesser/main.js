...
guessBtn.addEventListener('click', function () {
  ...
  if (guess === '') {
    ...
    errorMsg.textContent = 'Please enter a movie.';
    setTimeout(() => {
      errorMsg.remove();
    }, 2500);
  } else if (guess.toLowerCase() === rightMovie.toLowerCase()) {
    message.textContent = `Correct, the movie is ${guess}!`;
    ...
    guessesLeft -= 1;
    message.textContent = `Wrong, ${guess} is not correct...you have ${guessesLeft} guesses left. Try again!.`;
  }
